This is a simple chat project, where you can register, and participate in simple conversation with other users. It was created by using: HTML, CSS, JS, React, NodeJS, Express, Socket IO
